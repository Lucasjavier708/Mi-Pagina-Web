...
function initBouncingPulse() {
  ...
  dividers.forEach(divider => {
    ...
    let time = 0;
    let speed = Math.random() * 0.003 + 0.001; // velocidad más lenta
    let waveAmplitude = 0.4; // altura de la onda (0-1)
    let waveFrequency = Math.random() * 1.5 + 0.8; // frecuencia de la onda
